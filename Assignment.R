...
listOfDataframes = list("Jan_2014" = january_2014, "Feb_2014" = february_2014,"Mar_2014" =march_2014,"Apr_2014"=april_2014,"May_2014"=may_2014,"Jun_2014" = june_2014,
                        ...
                        "Jul_2015"=july_2015,"Aug_2015"=august_2015,"Sep_2015"=september_2015,"Oct_2015"=october_2015,"Dec_2015"=september_2015)
...
ggplot(national,aes(x=Period,y=N_POOU))+geom_bar(stat="identity")

ggplot(listOfDataframes[[4]], aes(N_OAPC ))+geom_boxplot()+ggtitle("Number of Offences Against The Person Convictions in January 2017")+xlab("Number of Offences Against The Person Convictions")
view(listOfDataframes[1])
